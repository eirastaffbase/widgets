...
import { ShiftViewerProps, ShiftViewer } from "./shift-viewer";
import { configurationSchema, uiSchema } from "./configuration-schema";
import icon from "../resources/shift-viewer.svg";
...
const factory: BlockFactory = (BaseBlockClass, _widgetApi) => {
  /**
   *  <shift-viewer message="world!"></shift-viewer>
   */
  return class ShiftViewerBlock extends BaseBlockClass implements BaseBlock {
    ...
    private get props(): ShiftViewerProps {
      const attrs = this.parseAttributes<ShiftViewerProps>();
      return {
        ...attrs,
    ...
    public renderBlock(container: HTMLElement): void {
      ...
      this._root.render(<ShiftViewer {...this.props} />);
    }
