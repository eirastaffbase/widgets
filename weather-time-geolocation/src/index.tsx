...
import { WeatherTimeGeolocationProps, WeatherTimeGeolocation } from "./weather-time-geolocation";
import { configurationSchema, uiSchema } from "./configuration-schema";
import icon from "../resources/weather-time-geolocation.svg";
...
const factory: BlockFactory = (BaseBlockClass, _widgetApi) => {
  /**
   *  <weather-time-geolocation city="New York" allowcityoverride="true"></weather-time-geolocation>
   */
  return class WeatherTimeGeolocationBlock extends BaseBlockClass implements BaseBlock {
    ...
    private get props(): WeatherTimeGeolocationProps {
      const attrs = this.parseAttributes<WeatherTimeGeolocationProps>();
      return {
        ...attrs,
    ...
    public renderBlock(container: HTMLElement): void {
      ...
      this._root.render(<WeatherTimeGeolocation {...this.props} />);
    }
