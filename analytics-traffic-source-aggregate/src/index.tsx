...
import { AnalyticsTrafficSourceAggregateProps, AnalyticsTrafficSourceAggregate } from "./analytics-traffic-source-aggregate";
import { configurationSchema, uiSchema } from "./configuration-schema";
import icon from "../resources/analytics-traffic-source-aggregate.svg";
...
const factory: BlockFactory = (BaseBlockClass, _widgetApi) => {
  /**
   *  <analytics-traffic-source-aggregate message="world!"></analytics-traffic-source-aggregate>
   */
  return class AnalyticsTrafficSourceAggregateBlock extends BaseBlockClass implements BaseBlock {
    ...
    private get props(): AnalyticsTrafficSourceAggregateProps {
      const attrs = this.parseAttributes<AnalyticsTrafficSourceAggregateProps>();
      return {
        ...attrs,
    ...
    public renderBlock(container: HTMLElement): void {
      ...
      this._root.render(<AnalyticsTrafficSourceAggregate {...this.props} />);
    }
...
const blockDefinition: BlockDefinition = {
    name: "analytics-traffic-source-aggregate",
    factory: factory,
