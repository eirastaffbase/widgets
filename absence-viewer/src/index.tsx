...
import { AbsenceViewerProps, AbsenceViewer } from "./absence-viewer";
import { configurationSchema, uiSchema } from "./configuration-schema";
import icon from "../resources/absence-viewer.svg";
...
const factory: BlockFactory = (BaseBlockClass, _widgetApi) => {
  /**
   *  <absence-viewer symbol="world!"></absence-viewer>
   */
  return class AbsenceViewerBlock extends BaseBlockClass implements BaseBlock {
    ...
    private get props(): AbsenceViewerProps {
      const attrs = this.parseAttributes<AbsenceViewerProps>();
      return {
        ...attrs,
    ...
    public renderBlock(container: HTMLElement): void {
      ...
      this._root.render(<AbsenceViewer {...this.props} />);
    }
