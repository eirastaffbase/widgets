...
import { StaticTasksProps, StaticTasks } from "./static-tasks";
import { configurationSchema, uiSchema } from "./configuration-schema";
import icon from "../resources/static-tasks.svg";
...
const factory: BlockFactory = (BaseBlockClass, _widgetApi) => {
  /**
   *  <static-tasks message="world!"></static-tasks>
   */
  return class StaticTasksBlock extends BaseBlockClass implements BaseBlock {
    ...
    private get props(): StaticTasksProps {
      const attrs = this.parseAttributes<StaticTasksProps>();
      return {
        ...attrs,
    ...
    public renderBlock(container: HTMLElement): void {
      ...
      this._root.render(<StaticTasks {...this.props} />);
    }
