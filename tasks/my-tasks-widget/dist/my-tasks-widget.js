    ...
    return class MyTasksWidget extends BaseBlockClass {
      ...
      `;
        ...
        <div class="${p}-proof-card">
          ...
          ${(pa === null || pa === void 0 ? void 0 : pa.notes) ? `<div class="${p}-detail-desc-label">${tr("notes")}</div><div class="${p}-detail-desc" style="margin-bottom:18px" dir="auto">${linkifyEscaped(esc(ct(pa.notes)))}</div>` : ""}
