...
import { SpotifyWidgetProps, SpotifyWidget } from "./spotify-widget";
...
const factory: BlockFactory = (BaseBlockClass, _widgetApi) => {
  /**
   *  <spotify-widget message="world!"></spotify-widget>
   */
  return class SpotifyWidgetBlock extends BaseBlockClass implements BaseBlock {
    public constructor() {
      super();
    }

    private get props(): SpotifyWidgetProps {
      const attrs = this.parseAttributes<SpotifyWidgetProps>();
      return {
        ...attrs,
    ...
    public renderBlock(container: HTMLElement): void {
      ReactDOM.render(<SpotifyWidget {...this.props} />, container);
    }
